...
export default function Boundless() {
  return (
    <section>
      ...
      <section>
        <ImageSection
          src="/gifs/boundless/b1b2.gif"
          header="B1/B2 Travel Visa Questionnaire"
        >
        ...
        <ImageSection
          src="/gifs/boundless/address-history.gif"
          header="Address & Employment History"
        >
        ...
        <ImageSection
          src="/gifs/boundless/doc-upload.gif"
        ...
        <ImageSection
          src="/gifs/boundless/milestone-tracker.gif"
        ...
        <ImageSection src="/gifs/boundless/checkout.gif" header="Checkout Page">
