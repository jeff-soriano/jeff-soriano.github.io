  ...
  return (
    <section>
      ...
      <p>
        ...
        afterward I worked in the gaming industry for a few years. Then I moved
        to Las Vegas, which is where I live now.
      </p>
      <br />
      ...
      <p>
        ...
        taught myself <strong>React and NodeJS</strong>, which helped me land a
        job at Boundless Immigration. There, my skills grew to include{' '}
